...
import {
  FIGURE_9_CHRYSANTHEMUM_NONVERBAL_CHAPTER_STILL_PAIRS,
  FIGURE_9_CHRYSANTHEMUM_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_9_CHRYSANTHEMUM_NONVERBAL_VIDEO_PAIRS,
  FIGURE_9_CHRYSANTHEMUM_VIDEOS,
} from './figure-9_chrysanthemum';
...
import {
  FIGURE_13_EASY_BROOM_NONVERBAL_CHAPTER_STILL_PAIRS,
...
import {
  FIGURE_28_ATANUA_HOUSE_NONVERBAL_CHAPTER_STILL_PAIRS,
  FIGURE_28_ATANUA_HOUSE_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_28_ATANUA_HOUSE_NONVERBAL_VIDEO_PAIRS,
  FIGURE_28_ATANUA_HOUSE_VIDEOS,
} from './figure-28_atanua-house';
...
import {
  FIGURE_42_APACHES_DOOR_NONVERBAL_CHAPTER_STILL_PAIRS,
  FIGURE_42_APACHES_DOOR_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_42_APACHES_DOOR_NONVERBAL_VIDEO_PAIRS,
  FIGURE_42_APACHES_DOOR_VIDEOS,
} from './figure-42_apaches-door';
import { FIGURE_43_TRAMPOLINE_VIDEOS } from './figure-43_trampoline';
import { FIGURE_44_BUTTERFLY_VIDEOS } from './figure-44_butterfly';
import {
  FIGURE_45_HAMMOCK_NONVERBAL_CHAPTER_STILL_PAIRS,
  FIGURE_45_HAMMOCK_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_45_HAMMOCK_NONVERBAL_VIDEO_PAIRS,
  FIGURE_45_HAMMOCK_VIDEOS,
} from './figure-45_hammock';
import {
  FIGURE_46_RABIT_NONVERBAL_CHAPTER_STILL_PAIRS,
  FIGURE_46_RABIT_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_46_RABIT_NONVERBAL_VIDEO_PAIRS,
  FIGURE_46_RABIT_VIDEOS,
} from './figure-46_rabit';
import { FIGURE_47_TURTLE_VIDEOS } from './figure-47_turtle';
import { FIGURE_48_SHOVEL_VIDEOS } from './figure-48_shovel';
import { FIGURE_49_CARIBOU_VIDEOS } from './figure-49_caribou';
import { FIGURE_50_2STORY_SIBERIAN_HOUSE_VIDEOS } from './figure-50_2story-siberian-house';
...
import {
  FIGURE_57_THUNDER_NONVERBAL_CHAPTER_STILL_PAIRS,
  FIGURE_57_THUNDER_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_57_THUNDER_NONVERBAL_VIDEO_PAIRS,
  FIGURE_57_THUNDER_VIDEOS,
} from './figure-57_thunder';
import { FIGURE_58_EARTH_AND_SKY_VIDEOS } from './figure-58_earth-and-sky';
import { FIGURE_59_KAYAKER_VIDEOS } from './figure-59_kayaker';
...
import { 
  FIGURE_71_SIBERIAN_HOUSE_VIDEOS,
  FIGURE_71_SIBERIAN_HOUSE_NONVERBAL_VIDEO_PAIRS,
  FIGURE_71_SIBERIAN_HOUSE_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_71_SIBERIAN_HOUSE_NONVERBAL_CHAPTER_STILL_PAIRS,
} from './figure-71_siberian-house';
...
import { FIGURE_79_OMAMORI_VIDEOS } from './figure-79_omamori';
...
import {
  FIGURE_100_HOLD_THE_SKY_NONVERBAL_CHAPTER_STILL_PAIRS,
  FIGURE_100_HOLD_THE_SKY_NONVERBAL_TOTAL_CHAPTERS,
  FIGURE_100_HOLD_THE_SKY_NONVERBAL_VIDEO_PAIRS,
  FIGURE_100_HOLD_THE_SKY_VIDEOS,
} from './figure-100_hold-the-sky';
...
export const CHAPTER_VIDEOS: Record<string, Record<number, any>> = {
  ...
  '49_caribou': FIGURE_49_CARIBOU_VIDEOS,
  '50_2story-siberian-house': FIGURE_50_2STORY_SIBERIAN_HOUSE_VIDEOS,
  ...
  '59_kayaker': FIGURE_59_KAYAKER_VIDEOS,
  ...
  '79_omamori': FIGURE_79_OMAMORI_VIDEOS,
  '80_calophyllum': FIGURE_80_CALOPHYLLUM_VIDEOS,
  '81_bat': FIGURE_81_BAT_VIDEOS,
...
export const NONVERBAL_CHAPTER_VIDEO_PAIRS: Record<string, Record<number, NonverbalChapterVideoPair>> = {
  ...
  '42_apaches-door': FIGURE_42_APACHES_DOOR_NONVERBAL_VIDEO_PAIRS,
  '45_hammock': FIGURE_45_HAMMOCK_NONVERBAL_VIDEO_PAIRS,
  '68_laia-flower': FIGURE_68_LAIA_FLOWER_NONVERBAL_VIDEO_PAIRS,
  '9_chrysanthemum': FIGURE_9_CHRYSANTHEMUM_NONVERBAL_VIDEO_PAIRS,
...
export const NONVERBAL_TOTAL_CHAPTERS: Record<string, number> = {
  ...
  '42_apaches-door': FIGURE_42_APACHES_DOOR_NONVERBAL_TOTAL_CHAPTERS,
  '45_hammock': FIGURE_45_HAMMOCK_NONVERBAL_TOTAL_CHAPTERS,
  '68_laia-flower': FIGURE_68_LAIA_FLOWER_NONVERBAL_TOTAL_CHAPTERS,
  '9_chrysanthemum': FIGURE_9_CHRYSANTHEMUM_NONVERBAL_TOTAL_CHAPTERS,
...
export const NONVERBAL_CHAPTER_STILL_PAIRS: Record<string, readonly NonverbalChapterStillTriple[]> = {
  ...
  '42_apaches-door': FIGURE_42_APACHES_DOOR_NONVERBAL_CHAPTER_STILL_PAIRS,
  ...
  '9_chrysanthemum': FIGURE_9_CHRYSANTHEMUM_NONVERBAL_CHAPTER_STILL_PAIRS,
