...
const NonverbalRestartButtonVertical = forwardRef<
  RestartButtonVerticalRef,
  NonverbalRestartButtonVerticalProps
...
export default NonverbalRestartButtonVertical;
