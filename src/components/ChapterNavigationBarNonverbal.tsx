...
export interface ChapterNavigationBarNonverbalRef {
  // 必要に応じて後で追加
}

const ChapterNavigationBarNonverbal = forwardRef<ChapterNavigationBarNonverbalRef, ChapterNavigationBarNonverbalProps>(({
  chapters,
  currentChapterIndex,
  onPreviousChapter,
  onReplay,
...
export default ChapterNavigationBarNonverbal;
