...
const VideoPlayerNonverbalControlPanel: React.FC<VideoPlayerNonverbalControlPanelProps> = ({
  stringFigure,
  chapters,
  currentChapterIndex,
  playbackPosition,
  ...
  return (
    <View style={[styles.leftPanel, { left: isSmallScreen ? 16 : isLargeScreen ? 60 : 48 }]}>
      ...
      <View style={styles.controlsContainer}>
        <ChapterNavigationVerticalBarNonverbal
...
export default VideoPlayerNonverbalControlPanel;
