...
const NonverbalPreviousChapterLandscapeButton = forwardRef<
  PreviousChapterLandscapeButtonRef,
  NonverbalPreviousChapterLandscapeButtonProps
>(({ onPress, currentChapterIndex, getLocalizedText, isTemporarilyDisabled = false }, ref) => {
...
export default NonverbalPreviousChapterLandscapeButton;
