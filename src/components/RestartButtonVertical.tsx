...
interface RestartButtonVerticalProps {
  onPress: () => void;
...
const RestartButtonVertical = forwardRef<RestartButtonVerticalRef, RestartButtonVerticalProps>(({
  onPress,
  currentChapterIndex,
  getLocalizedText,
    ...
    >
      <View style={styles.controlButton}>
        ...
        <Animated.View style={[
          ...
          <Text maxFontSizeMultiplier={1.25} style={[styles.controlButtonText]}>{getLocalizedText({ ja: 'はじめから', en: 'Restart' })}</Text>
          <SpeedButtonTail
...
export default RestartButtonVertical;
